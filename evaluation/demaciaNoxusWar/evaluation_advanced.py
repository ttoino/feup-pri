...
QUERY_URL = "http://localhost:8983/solr/luis-advanced/select?defType=edismax&df=content&indent=true&pf=content%5E1.5%20title&ps=10&q.op=AND&q=noxus%20demacia%20war&qf=content%5E2%20title%5E1.3&qs=10&useParams=&wt=json"
