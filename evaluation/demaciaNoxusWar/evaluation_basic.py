...
QUERY_URL = "http://localhost:8983/solr/luis-basic/select?indent=true&q.op=OR&q=related_champions.origin.description%3A(noxus%20demacia)&rows=40&useParams=&wt=json"
